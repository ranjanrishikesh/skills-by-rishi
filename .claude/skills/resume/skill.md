...
Read `.claude/skills/resume/rules.md` at the start and enforce throughout all phases.
...
Read `.claude/skills/resume/goal-discovery.md` and follow it exactly.
...
### Phase 3: The Review
Read `.claude/skills/resume/review-framework.md` and follow it exactly.
...
Read `.claude/skills/resume/devils-advocate.md` and follow it exactly.
...
Read `.claude/skills/resume/revamp-interview.md` and follow it exactly.
...
### Phase 6: The Revamp
Read `.claude/skills/resume/revamp-guide.md` and follow it exactly.
...
Read `.claude/skills/resume/coaching-notes.md` and follow it exactly.
- Deliver 3-5 prioritized next steps beyond the resume
- Each must reference a specific finding from Phase 3 or 4

### Phase 8: Export
Read `.claude/skills/resume/export.md` and follow it exactly.
- Generate docs/resume.md, docs/resume.html, and docs/resume.pdf
...
Read `.claude/skills/resume/experience-intake.md` and follow it exactly.
...
Read `.claude/skills/resume/resume-architecture.md` and follow it exactly.
...
Read `.claude/skills/resume/resume-writer.md` and follow it exactly.
